...
<div class="wrapper fixed__footer">
	<?php 
	    set_query_var( 'title', 'Login - Register' ); // -> truyền dữ liệu vào biến my_var -> truyền vào template
        ...
        get_template_part( 'public/template/login', 'register' ); // -> login-register.php
