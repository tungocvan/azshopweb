                    ...
                    <ul class='product__small__images nav' role='tablist'>
                        <li role='presentation' class='pot-small-img'>
                            <a class='active' href='#img-tab-1' role='tab' data-toggle='tab'>
                                <img src='<?php echo TNV_URI_PUBLIC; ?>images/product-details/small-img/1.jpg' alt='small-image'>
                            </a>
                        </li>
                        <li role='presentation' class='pot-small-img'>
                            <a href='#img-tab-2' role='tab' data-toggle='tab'>
                                <img src='<?php echo TNV_URI_PUBLIC; ?>images/product-details/small-img/2.jpg' alt='small-image'>
                            </a>
                        </li>
                        <li role='presentation' class='pot-small-img'>
                            <a href='#img-tab-3' role='tab' data-toggle='tab'>
                                <img src='<?php echo TNV_URI_PUBLIC; ?>images/product-details/small-img/3.jpg' alt='small-image'>
                            </a>
                        </li>
                        <li role='presentation' class='pot-small-img'>
                    ...
                    <div class='product__big__images'>
                        <div class='portfolio-full-image tab-content'>
                            <div role='tabpanel' class='tab-pane fade show active product-video-position' id='img-tab-1'>
                                <img src='<?php echo TNV_URI_PUBLIC; ?>images/product-details/big-img/10.jpg' alt='full-image'>
                            ...
                            <div role='tabpanel' class='tab-pane fade product-video-position' id='img-tab-2'>
                                <img src='<?php echo TNV_URI_PUBLIC; ?>images/product-details/big-img/12.jpg' alt='full-image'>
                                <div class='product-video'>
                                    <a class='video-popup' href='https://www.youtube.com/watch?v=cDDWvj_q-o8'>
                                        <i class='zmdi zmdi-videocam'></i> View Video
                                    </a>
                            ...
                            <div role='tabpanel' class='tab-pane fade product-video-position' id='img-tab-3'>
                                <img src='<?php echo TNV_URI_PUBLIC; ?>images/product-details/big-img/11.jpg' alt='full-image'>
                                <div class='product-video'>
                                    <a class='video-popup' href='https://www.youtube.com/watch?v=cDDWvj_q-o8'>
                                        <i class='zmdi zmdi-videocam'></i> View Video
                                    </a>
                        ...
                        <div class='review__address__inner'>
                            ...
                            <div class='pro__review'>
                                <div class='review__thumb'>
                                    <img src='<?php echo TNV_URI_PUBLIC; ?>images/review/1.jpg' alt='review images'>
                                </div>
                            ...
                            <div class='pro__review ans'>
                                <div class='review__thumb'>
                                    <img src='<?php echo TNV_URI_PUBLIC; ?>images/review/2.jpg' alt='review images'>
                                </div>
                                <div class='review__details'>
                                    <div class='review__info'>
                                        <h4><a href='#'>Gerald Barnes</a></h4>
