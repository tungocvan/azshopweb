...
<div class='htc__login__register bg__white ptb--130' style='background: rgba(0, 0, 0, 0) url(<?php echo TNV_URI_PUBLIC; ?>images/bg/5.jpg) no-repeat scroll center center / cover ;'>
    <div class='container'>
        <div class='row'>
